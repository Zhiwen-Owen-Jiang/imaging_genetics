...
class Test_saddle(unittest.TestCase):
    def test_saddle(self):
        ## single voxel
        pvalues = saddle2(np.array([6.0]), np.array([4.0, 3.0, 2.0, 1.0]))
        assert_array_almost_equal(pvalues, np.array([0.6329193]))

        ## multiple voxels
        pvalues = saddle2(np.array([6.0, 5.0]), np.array([4.0, 3.0, 2.0, 1.0]))
        assert_array_almost_equal(pvalues, np.array([0.6329193, 0.7069172]))

        ## extreme voxels
        pvalues = saddle2(np.array([60.0]), np.array([4.0, 3.0, 2.0, 1.0]))
        assert_array_almost_equal(pvalues, np.array([0.0004239342]))

        pvalues = saddle2(np.array([600.0]), np.array([4.0, 3.0, 2.0, 1.0]))
        assert_array_almost_equal(pvalues, np.array([6.531105e-34]))

        ## very small stats
        pvalues = saddle2(np.array([0.1]), np.array([4.0, 3.0, 2.0, 1.0]))
        assert_array_almost_equal(pvalues, np.array([0.9997457]))

        pvalues = saddle2(np.array([0.0001]), np.array([4.0, 3.0, 2.0, 1.0]))
        assert_array_almost_equal(pvalues, np.array([1.0]))
        
        ## corner cases
        pvalues = saddle2(np.array([6.0]), np.array([3.0, 2.0, 1.0]))
        assert_array_almost_equal(pvalues, np.array([0.36787944]))

        pvalues = saddle2(np.array([10.0]), np.array([4.0, 3.0, 2.0, 1.0]))
        assert_array_almost_equal(pvalues, np.array([0.38244247]))
    ...
    def test_handle_invalid_pvalues(self):
        ...
        pvalues1 = liu_mod(np.array([60.0, 6.0]), egvalues)
        pvalues2 = saddle2(np.array([60.0, 6.0]), egvalues)
...
if __name__ == "__main__":
    ...
    print(saddle(score_stats, egvalues, 
                 np.array([[1.48967545e-02, 1.05388240e-06],
                          [1.05388240e-06, 9.45317448e-03]]) * 67.12873613372044))
