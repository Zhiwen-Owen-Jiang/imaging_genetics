...
from heig.wgs.utils import preprocess_mt
...
if __name__ == '__main__':
    ...
    # snps_mt = preprocess_mt(snps_mt, start=51065600, end=51094926, maf_thresh=0.5)
    ...
    # snps_mt = preprocess_mt(snps_mt, maf_thresh=0.5, start=14677301, end=20298186)
    ...
    #                           reference_genome='GRCh37')
    # snps_mt = preprocess_mt(snps_mt, maf_thresh=0.02)
