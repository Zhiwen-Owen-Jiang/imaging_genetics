...
class RVcluster:
    ...
    def __init__(self, null_model, vset, locus, temp_path, loco_preds=None):
        """
        Parameters:
        ------------
    ...
    def _sliding_window(self):
        ...
        sliding_window = SlidingWindow(
            rv_sumstats, window_length=1000, sliding_length=3000
        )
    ...
    def cluster_analysis(self):
        ...
        cluster_size_df = pd.DataFrame(
            np.array(cluster_size_list), columns=pvalues.columns
        )
...
def run(args, log):
    ...
    try:
        ...
        cluster = RVcluster(null_model, vset, locus, temp_path, loco_preds)
